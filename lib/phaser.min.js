...
(function () {
    ...
    b.sharedCanvas = document.createElement("canvas"),
    ...
    b.DisplayObjectContainer.prototype.addChildAt = function (a, b) {
        if (b >= 0 && b <= this.children.length)
            return a.parent && a.parent.removeChild(a), a.parent = this, this.children.splice(b, 0, a), this.stage && a.setStageReference(this.stage), a;
    ...
    b.DisplayObjectContainer.prototype.getBounds = function () {
        ...
        for (var a, c, d, e = 1 / 0, f = 1 / 0, g = -1 / 0, h = -1 / 0, i = !1, j = 0, k = this.children.length; j < k; j++) {
            this.children[j].visible && (i = !0, a = this.children[j].getBounds(), e = e < a.x ? e : a.x, f = f < a.y ? f : a.y, c = a.width + a.x, d = a.height + a.y, g = g > c ? g : c, h = h > d ? h : d)
        }
        if (!i)
            return b.EmptyRectangle;
        var l = this._bounds;
    ...
    b.Sprite.prototype.getBounds = function (a) {
        ...
        r = 1 / 0;
        if (0 === j && 0 === k)
            i < 0 && (i *= -1), l < 0 && (l *= -1), q = i * e + m, o = i * d + m, r = l * g + n, p = l * f + n;
        else {
            var s = i * e + k * g + m,
            t = l * g + j * e + n,
            u = i * d + k * g + m,
    ...
    b.Sprite.prototype._renderWebGL = function (a) {
        if (this.visible && !(this.alpha <= 0) && this.renderable) {
            ...
            if (this._mask || this._filters) {
                var c = a.spriteBatch;
                for (this._filters && (c.flush(), a.filterManager.pushFilter(this._filterBlock)), this._mask && (c.stop(), a.maskManager.pushMask(this.mask, a), c.start()), c.render(this), b = 0; b < this.children.length; b++)
                    this.children[b]._renderWebGL(a);
                c.stop(),
                this._mask && a.maskManager.popMask(this._mask, a),
                this._filters && a.filterManager.popFilter(),
                ...
                for (a.spriteBatch.render(this), b = 0; b < this.children.length; b++)
                    this.children[b]._renderWebGL(a)
        }
    },
    b.Sprite.prototype._renderCanvas = function (a) {
        if (!(!1 === this.visible || 0 === this.alpha || !1 === this.renderable || this.texture.crop.width <= 0 || this.texture.crop.height <= 0)) {
            ...
            for (var c = this.worldTransform, d = !0, e = 0; e < this.children.length; e++) {
                ...
                if (f.visible) {
                    ...
                    if (b.globalAlpha = this.worldAlpha * f.alpha, f.rotation % (2 * Math.PI) == 0)
                        d && (b.setTransform(c.a, c.b, c.c, c.d, c.tx, c.ty), d = !1), b.drawImage(g.baseTexture.source, h.x, h.y, h.width, h.height, f.anchor.x * (-h.width * f.scale.x) + f.position.x + .5 | 0, f.anchor.y * (-h.height * f.scale.y) + f.position.y + .5 | 0, h.width * f.scale.x, h.height * f.scale.y);
                    else {
                        d || (d = !0),
    ...
    b.Text = function (a, c, d) {
        this.resolution = 1;
        var e;
        a.renderType === Phaser.WEBGL ? (b.Text.drawCanvas || (b.Text.drawCanvas = document.createElement("canvas"), b.Text.drawContext = b.Text.drawCanvas.getContext("2d"), b.Text.drawSprite = b.Texture.fromCanvas(b.Text.drawCanvas)), this.canvas = b.Text.drawCanvas, this.context = b.Text.drawContext, e = this._frameTexture = new qc.RenderTexture(0, 0), this._canvasMode = !1) : (this.canvas = document.createElement("canvas"), this.context = this.canvas.getContext("2d"), e = b.Texture.fromCanvas(this.canvas), this._canvasMode = !0),
        b.Sprite.call(this, e),
        this.setText(c),
        this.setStyle(d)
    },
    ...
    b.Text.prototype.updateText = function () {
        ...
        if (this.style.dropShadow) {
            ...
            for (f = 0; f < b.length; f++)
                k = this.style.strokeThickness / 2, l = this.style.strokeThickness / 2 + f * i + e.ascent, "right" === this.style.align ? k += d - c[f] : "center" === this.style.align && (k += (d - c[f]) / 2), this.style.fill && this.context.fillText(b[f], k + m, l + n)
        }
        for (this.context.fillStyle = this.style.fill, f = 0; f < b.length; f++)
            k = this.style.strokeThickness / 2, l = this.style.strokeThickness / 2 + f * i + e.ascent, "right" === this.style.align ? k += d - c[f] : "center" === this.style.align && (k += (d - c[f]) / 2), this.style.stroke && this.style.strokeThickness && this.context.strokeText(b[f], k, l), this.style.fill && this.context.fillText(b[f], k, l);
        this.updateTexture()
    },
    ...
    b.Text.prototype.determineFontProperties = function (a) {
        ...
        if (!c) {
            c = {},
            b.Text.fontPropertiesCanvas || (b.Text.fontPropertiesCanvas = document.createElement("canvas"), b.Text.fontPropertiesContext = b.Text.fontPropertiesCanvas.getContext("2d"));
    ...
    b.Text.prototype.destroy = function (a) {
        this.context = null,
        this.canvas = null,
        this.texture.destroy(void 0 === a || a)
    },
    b.Text.fontPropertiesCache = {},
    b.Text.fontPropertiesCanvas = null,
    b.Text.fontPropertiesContext = null,
    ...
    b.BitmapText.prototype.updateText = function () {
        for (var a = b.BitmapText.fonts[this.fontName], c = new b.Point, d = null, e = [], f = 0, g = [], h = 0, i = this.fontSize / a.size, j = 0, k = 0; k < this.text.length; k++) {
            ...
            if (j = /(\s)/.test(this.text.charAt(k)) ? k : j, /(?:\r\n|\r|\n)/.test(this.text.charAt(k)))
                g.push(c.x), f = Math.max(f, c.x), h++, c.x = 0, c.y += a.lineHeight, d = null;
            else if (-1 !== j && this.maxWidth > 0 && c.x * i > this.maxWidth)
                e.splice(j, k - j), k = j, j = -1, g.push(lastLineWidth), f = Math.max(f, lastLineWidth), h++, c.x = 0, c.y += a.lineHeight, d = null;
            else {
                var m = a.chars[l];
        ...
        for (k = 0; k < q; k++) {
            var u = k < p ? this.children[k] : this._pool.pop();
    ...
    b.canUseNewCanvasBlendModes = function () {
        ...
        return "multiply" === c.globalCompositeOperation && 255 === d[0] && 0 === d[1] && 0 === d[2]
    },
            ...
            if (h.type === b.Graphics.POLY) {
                if (h.points = h.shape.points.slice(), h.shape.closed && (h.points[0] === h.points[h.points.length - 2] && h.points[1] === h.points[h.points.length - 1] || h.points.push(h.points[0], h.points[1])), h.fill && h.points.length >= 6)
                    if (h.points.length < 12) {
                        ...
                        g = b.WebGLGraphics.switchMode(d, 1), b.WebGLGraphics.buildComplexPoly(h, g);
                h.lineWidth > 0 && (g = b.WebGLGraphics.switchMode(d, 0), b.WebGLGraphics.buildLine(h, g))
            } else
                g = b.WebGLGraphics.switchMode(d, 0), h.type === b.Graphics.RECT ? b.WebGLGraphics.buildRectangle(h, g) : h.type === b.Graphics.CIRC || h.type === b.Graphics.ELIP ? b.WebGLGraphics.buildCircle(h, g) : h.type === b.Graphics.RREC && b.WebGLGraphics.buildRoundedRectangle(h, g);
            d.lastIndex++
        }
    ...
    b.WebGLGraphics.buildRoundedRectangle = function (a, c) {
        ...
        if (j.push(e, f + i), j = j.concat(b.WebGLGraphics.quadraticBezierCurve(e, f + h - i, e, f + h, e + i, f + h)), j = j.concat(b.WebGLGraphics.quadraticBezierCurve(e + g - i, f + h, e + g, f + h, e + g, f + h - i)), j = j.concat(b.WebGLGraphics.quadraticBezierCurve(e + g, f + i, e + g, f, e + g - i, f)), j = j.concat(b.WebGLGraphics.quadraticBezierCurve(e + i, f, e, f, e, f + i)), a.fill) {
            ...
            for (t = 0; t < s.length; t += 3)
                q.push(s[t] + r), q.push(s[t] + r), q.push(s[t + 1] + r), q.push(s[t + 2] + r), q.push(s[t + 2] + r);
    ...
    b.WebGLGraphics.quadraticBezierCurve = function (a, b, c, d, e, f) {
        ...
        for (var h, i, j, k, l, m, n = 20, o = [], p = 0, q = 0; q <= n; q++)
            p = q / n, h = g(a, c, p), i = g(b, d, p), j = g(c, e, p), k = g(d, f, p), l = g(h, j, p), m = g(i, k, p), o.push(l, m);
        return o
    },
    b.WebGLGraphics.buildCircle = function (a, c) {
        ...
        if (a.fill) {
            ...
            r = c.indices,
            s = q.length / 6;
            for (r.push(s), k = 0; k < i + 1; k++)
                q.push(g, h, n, o, p, m), q.push(g + Math.sin(j * k) * d, h + Math.cos(j * k) * e, n, o, p, m), r.push(s++, s++);
            r.push(s - 1)
        }
        if (a.lineWidth) {
            var t = a.points;
            for (a.points = [], k = 0; k < i + 1; k++)
    ...
    b.WebGLGraphics.buildLine = function (a, c) {
        ...
        if (0 !== e.length) {
            ...
            P = M[1] * N,
            Q = M[2] * N;
            for (l = e[0], m = e[1], n = e[2], o = e[3], r =  - (m - o), s = l - n, F = Math.sqrt(r * r + s * s), r /= F, s /= F, r *= L, s *= L, G.push(l - r, m - s, O, P, Q, N), G.push(l + r, m + s, O, P, Q, N), d = 1; d < I - 1; d++)
                l = e[2 * (d - 1)], m = e[2 * (d - 1) + 1], n = e[2 * d], o = e[2 * d + 1], p = e[2 * (d + 1)], q = e[2 * (d + 1) + 1], r =  - (m - o), s = l - n, F = Math.sqrt(r * r + s * s), r /= F, s /= F, r *= L, s *= L, t =  - (o - q), u = n - p, F = Math.sqrt(t * t + u * u), t /= F, u /= F, t *= L, u *= L, x = -s + m - (-s + o), y = -r + n - (-r + l), z = (-r + l) * (-s + o) - (-r + n) * (-s + m), A = -u + q - (-u + o), B = -t + n - (-t + p), C = (-t + p) * (-u + o) - (-t + n) * (-u + q), D = x * B - A * y, Math.abs(D) < .1 ? (D += 10.1, G.push(n - r, o - s, O, P, Q, N), G.push(n + r, o + s, O, P, Q, N)) : (j = (y * C - B * z) / D, k = (A * z - x * C) / D, E = (j - n) * (j - n) + (k - o) + (k - o), E > 19600 ? (v = r - t, w = s - u, F = Math.sqrt(v * v + w * w), v /= F, w /= F, v *= L, w *= L, G.push(n - v, o - w), G.push(O, P, Q, N), G.push(n + v, o + w), G.push(O, P, Q, N), G.push(n - v, o - w), G.push(O, P, Q, N), J++) : (G.push(j, k), G.push(O, P, Q, N), G.push(n - (j - n), o - (k - o)), G.push(O, P, Q, N)));
            for (l = e[2 * (I - 2)], m = e[2 * (I - 2) + 1], n = e[2 * (I - 1)], o = e[2 * (I - 1) + 1], r =  - (m - o), s = l - n, F = Math.sqrt(r * r + s * s), r /= F, s /= F, r *= L, s *= L, G.push(n - r, o - s), G.push(O, P, Q, N), G.push(n + r, o + s), G.push(O, P, Q, N), H.push(K), d = 0; d < J; d++)
                H.push(K++);
            H.push(K - 1)
        }
    },
    b.WebGLGraphics.buildComplexPoly = function (a, c) {
        ...
        if (!(d.length < 6)) {
            ...
            for (var f, g, h = 1 / 0, i = -1 / 0, j = 1 / 0, k = -1 / 0, l = 0; l < d.length; l += 2)
                f = d[l], g = d[l + 1], h = f < h ? f : h, i = f > i ? f : i, j = g < j ? g : j, k = g > k ? g : k;
    ...
    b.WebGLRenderer.prototype.handleContextRestored = function () {
        ...
        for (var a in b.TextureCache) {
            b.TextureCache[a].baseTexture._glTextures = []
        }
        this.contextLost = !1
    },
    ...
    b.WebGLSpriteBatch.prototype.render = function (a) {
        ...
        if (c) {
            ...
            if (b.trim) {
                ...
                d = b.frame.width * (1 - h), e = b.frame.width * -h, f = b.frame.height * (1 - i), g = b.frame.height * -i;
    ...
    b.WebGLFastSpriteBatch.prototype.renderSprite = function (a) {
        if (a.visible && (a.texture.baseTexture === this.currentBaseTexture || (this.flush(), this.currentBaseTexture = a.texture.baseTexture, a.texture._uvs))) {
            ...
            if (b = a.texture._uvs, a.texture.frame.width, a.texture.frame.height, a.texture.trim) {
                ...
                d = i.x - a.anchor.x * i.width,
                c = d + a.texture.crop.width,
                f = i.y - a.anchor.y * i.height,
                e = f + a.texture.crop.height
            } else
                c = a.texture.frame.width * (1 - a.anchor.x), d = a.texture.frame.width * -a.anchor.x, e = a.texture.frame.height * (1 - a.anchor.y), f = a.texture.frame.height * -a.anchor.y;
    ...
    b.CanvasTinter.checkInverseAlpha = function () {
        if (window.__wx && window.isSubDomain)
            return !1;
        var a = b.sharedCanvas,
        c = a.getContext("2d");
        ...
        var e = c.getImageData(1, 0, 1, 1);
        return e.data[0] === d.data[0] && e.data[1] === d.data[1] && e.data[2] === d.data[2] && e.data[3] === d.data[3]
    },
    ...
    b.CanvasGraphics.renderGraphics = function (a, c) {
        ...
        for (var e = 0; e < a.graphicsData.length; e++) {
            ...
            if (c.lineWidth = f.lineWidth, f.type === b.Graphics.POLY) {
                ...
                (f.fillColor || 0 === f.fillColor) && (c.globalAlpha = f.fillAlpha * d, c.fillStyle = "#" + ("00000" + (0 | h).toString(16)).substr(-6), c.fillRect(g.x, g.y, g.width, g.height)), f.lineWidth && (c.globalAlpha = f.lineAlpha * d, c.strokeStyle = "#" + ("00000" + (0 | i).toString(16)).substr(-6), c.strokeRect(g.x, g.y, g.width, g.height));
            else if (f.type === b.Graphics.CIRC)
                c.beginPath(), c.arc(g.x, g.y, g.radius, 0, 2 * Math.PI), c.closePath(), f.fill && (c.globalAlpha = f.fillAlpha * d, c.fillStyle = "#" + ("00000" + (0 | h).toString(16)).substr(-6), c.fill()), f.lineWidth && (c.globalAlpha = f.lineAlpha * d, c.strokeStyle = "#" + ("00000" + (0 | i).toString(16)).substr(-6), c.stroke());
        ...
        if (0 !== d) {
            ...
            for (var e = 0; e < d; e++) {
                ...
                if (f.type === b.Graphics.POLY) {
                    ...
                    c.rect(g.x, g.y, g.width, g.height), c.closePath();
                else if (f.type === b.Graphics.CIRC)
                    c.arc(g.x, g.y, g.radius, 0, 2 * Math.PI), c.closePath();
                else if (f.type === b.Graphics.ELIP) {
                    var j = 2 * g.width,
                    k = 2 * g.height,
                    l = g.x - j / 2,
    ...
    b.Graphics.prototype.quadraticCurveTo = function (a, b, c, d) {
        ...
        for (var i = h[h.length - 2], j = h[h.length - 1], k = 0, l = 1; l <= g; ++l)
            k = l / g, e = i + (a - i) * k, f = j + (b - j) * k, h.push(e + (a + (c - a) * k - e) * k, f + (b + (d - b) * k - f) * k);
        return this.dirty = !0,
        this
    },
    ...
    b.Graphics.prototype.arc = function (a, b, c, d, e, f) {
        ...
        for (var k = this.currentPath.shape.points, l = g / (2 * h), m = 2 * l, n = Math.cos(l), o = Math.sin(l), p = h - 1, q = p % 1 / p, r = 0; r <= p; r++) {
            var s = r + q * r,
            t = l + d + m * s,
            u = Math.cos(t),
            v = -Math.sin(t);
    ...
    b.Graphics.prototype._renderWebGL = function (a) {
        if (!1 !== this.visible && 0 !== this.alpha && !0 !== this.isMask) {
            if (this._cacheAsBitmap)
                return (this.dirty || this.cachedSpriteDirty) && (this._generateCachedSprite(), this.updateCachedSpriteTexture(), this.cachedSpriteDirty = !1, this.dirty = !1), this._cachedSprite.worldAlpha = this.worldAlpha, void b.Sprite.prototype._renderWebGL.call(this._cachedSprite, a);
    ...
    b.Graphics.prototype._renderCanvas = function (a) {
        if (!0 !== this.isMask) {
            if (this._prevTint !== this.tint && (this.dirty = !0, this._prevTint = this.tint), this._cacheAsBitmap)
                return (this.dirty || this.cachedSpriteDirty) && (this._generateCachedSprite(), this.updateCachedSpriteTexture(), this.cachedSpriteDirty = !1, this.dirty = !1), this._cachedSprite.alpha = this.alpha, void b.Sprite.prototype._renderCanvas.call(this._cachedSprite, a);
            var c = a.context,
        ...
        if (this.graphicsData.length)
            for (var f, g, h, i, j, k, l = 0; l < this.graphicsData.length; l++) {
                ...
                if (f = m.shape, n === b.Graphics.RECT || n === b.Graphics.RREC)
                    h = f.x - o / 2, i = f.y - o / 2, j = f.width + o, k = f.height + o, a = h < a ? h : a, c = h + j > c ? h + j : c, d = i < d ? i : d, e = i + k > e ? i + k : e;
                else if (n === b.Graphics.CIRC)
                    h = f.x, i = f.y, j = f.radius + o / 2, k = f.radius + o / 2, a = h - j < a ? h - j : a, c = h + j > c ? h + j : c, d = i - k < d ? i - k : d, e = i + k > e ? i + k : e;
                else if (n === b.Graphics.ELIP)
                    h = f.x, i = f.y, j = f.width + o / 2, k = f.height + o / 2, a = h - j < a ? h - j : a, c = h + j > c ? h + j : c, d = i - k < d ? i - k : d, e = i + k > e ? i + k : e;
                else {
                    g = f.points;
                    for (var p = 0; p < g.length; p++)
                        g[p]instanceof Phaser.Point ? (h = g[p].x, i = g[p].y) : (h = g[p], i = g[p + 1], p < g.length - 1 && p++), a = h - o < a ? h - o : a, c = h + o > c ? h + o : c, d = i - o < d ? i - o : d, e = i + o > e ? i + o : e
                }
            }
        else
            a = 0, c = 0, d = 0, e = 0;
    ...
    b.Rope.prototype.refresh = function () {
        ...
        if (!(a.length < 1)) {
            ...
            c[0] = 0,
            c[1] = 1;
            for (var e, f, g, h = a.length, i = 1; i < h; i++)
                e = a[i], f = 4 * i, g = i / (h - 1), b[f] = g, b[f + 1] = 0, b[f + 2] = g, b[f + 3] = 1, f = 2 * i, d[f] = 1, d[f + 1] = 1, f = 2 * i, c[f] = f, c[f + 1] = f + 1, e
        }
    },
    b.Rope.prototype.updateTransform = function () {
        ...
        if (!(a.length < 1)) {
            ...
            for (var f, g, h, i, j, k = this.vertices, l = a.length, m = 0; m < l; m++)
                f = a[m], g = 4 * m, c = m < a.length - 1 ? a[m + 1] : f, e.y =  - (c.x - d.x), e.x = c.y - d.y, h = 10 * (1 - m / (l - 1)), h > 1 && (h = 1), i = Math.sqrt(e.x * e.x + e.y * e.y), j = this.texture.height / 2, e.x /= i, e.y /= i, e.x *= j, e.y *= j, k[g] = f.x + e.x, k[g + 1] = f.y + e.y, k[g + 2] = f.x - e.x, k[g + 3] = f.y - e.y, d = f;
            b.DisplayObjectContainer.prototype.updateTransform.call(this)
        }
    },
    ...
    b.RenderTexture = function (a, c, d, e, f) {
        if (this.width = a || 100, this.height = c || 100, this.resolution = f || 1, this.frame = new b.Rectangle(0, 0, this.width * this.resolution, this.height * this.resolution), this.crop = new b.Rectangle(0, 0, this.width * this.resolution, this.height * this.resolution), this.baseTexture = new b.BaseTexture, this.baseTexture.width = this.width * this.resolution, this.baseTexture.height = this.height * this.resolution, this.baseTexture._glTextures = [], this.baseTexture.resolution = this.resolution, this.baseTexture.scaleMode = e || b.scaleModes.DEFAULT, this.baseTexture.hasLoaded = !0, b.Texture.call(this, this.baseTexture, new b.Rectangle(0, 0, this.width * this.resolution, this.height * this.resolution)), this.renderer = d || b.defaultRenderer, this.renderer.type === b.WEBGL_RENDERER) {
            ...
            this.render = this.renderCanvas, this.textureBuffer = new b.CanvasBuffer(this.width * this.resolution, this.height * this.resolution), this.baseTexture.source = this.textureBuffer.canvas;
        this.valid = !0,
        this._updateUvs()
    },
    ...
    if (window.Phaser = c, Math.trunc || (Math.trunc = function (a) {
        ...
        extend: function () {
            ...
            for ("boolean" == typeof h && (k = h, h = arguments[1] || {}, i = 2), j === i && (h = this, --i); i < j; i++)
                if (null != (a = arguments[i]))
                    for (b in a)
                        d = h[b], e = a[b], h !== e && (k && e && (c.Utils.isPlainObject(e) || (f = Array.isArray(e))) ? (f ? (f = !1, g = d && Array.isArray(d) ? d : []) : g = d && c.Utils.isPlainObject(d) ? d : {}, h[b] = c.Utils.extend(k, g, e)) : void 0 !== e && (h[b] = e));
            return h
        },
    ...
    c.Circle.intersectsRectangle = function (a, b) {
        ...
        if (d > b.halfHeight + a.radius)
            return !1;
        if (c <= b.halfWidth || d <= b.halfHeight)
            return !0;
        var e = c - b.halfWidth,
        f = d - b.halfHeight;
    ...
    c.Polygon.prototype = {
        ...
        contains: function (a, b) {
            for (var c = this._points.length, d = !1, e = -1, f = c - 1; ++e < c; f = e) {
                ...
                i = this._points[f].x,
                j = this._points[f].y;
                (h <= b && b < j || j <= b && b < h) && a < (i - g) * (b - h) / (j - h) + g && (d = !d)
            }
            return d
        },
        setTo: function (a) {
        ...
        calculateArea: function (a) {
            for (var b, c, d, e, f = 0, g = this._points.length; f < g; f++)
                b = this._points[f], c = f === g - 1 ? this._points[0] : this._points[f + 1], d = (b.y - a + (c.y - a)) / 2, e = b.x - c.x, this.area += d * e;
            return this.area
        }
    },
    ...
    c.StateManager = function (a, b) {
        ...
        void 0 !== b && null !== b && (this._pendingState = b),
        this._clearWorld = !1,
        this._clearCache = !1,
        this._created = !1,
        this._args = [],
    ...
    c.StateManager.prototype = {
        ...
        preUpdate: function () {
            if (this._pendingState && this.game.isBooted) {
                if (this.clearCurrentState(), this.setCurrentState(this._pendingState), this.current !== this._pendingState)
                    return;
                this._pendingState = null,
        ...
        unlink: function (a) {
            this.states[a] && (this.states[a].game = null, this.states[a].add = null, this.states[a].make = null, this.states[a].camera = null, this.states[a].cache = null, this.states[a].input = null, this.states[a].load = null, this.states[a].math = null, this.states[a].sound = null, this.states[a].scale = null, this.states[a].state = null, this.states[a].stage = null, this.states[a].time = null, this.states[a].tweens = null, this.states[a].world = null, this.states[a].rnd = null, this.states[a].physics = null)
        },
        ...
        remove: function (a) {
            for (this._i = this._len; this._i--; )
                if (this.plugins[this._i] === a)
                    return a.destroy(), this.plugins.splice(this._i, 1), void this._len--
        },
        removeAll: function () {
            for (this._i = this._len; this._i--; )
    ...
    c.Stage.prototype.checkVisibility = function () {
        ...
        window.__wx && "function" == typeof wx.onHide && (wx.onHide(function () {
                c.Stage.prototype.visibilityChange.call(a, {
                    type: "pause"
                })
            }), wx.onShow(function () {
    ...
    c.Group.prototype.checkProperty = function (a, b, d, e) {
        return void 0 === e && (e = !1),
        !(!c.Utils.getProperty(a, b) && e) && c.Utils.getProperty(a, b) === d
    },
    c.Group.prototype.set = function (a, b, c, d, e, f, g) {
        if (void 0 === g && (g = !1), b = b.split("."), void 0 === d && (d = !1), void 0 === e && (e = !1), (!1 === d || d && a.alive) && (!1 === e || e && a.visible))
    ...
    c.Group.prototype.iterate = function (a, b, d, e, f, g) {
        ...
        for (var h = 0, i = 0; i < this.children.length; i++)
            if (this.children[i][a] === b && (h++, e && (g ? (g[0] = this.children[i], e.apply(f, g)) : e.call(f, this.children[i])), d === c.Group.RETURN_CHILD))
    ...
    c.Group.prototype.remove = function (a, b, c) {
        if (void 0 === b && (b = !1), void 0 === c && (c = !1), 0 === this.children.length || -1 === this.children.indexOf(a))
            return !1;
    ...
    c.Group.prototype.removeAll = function (a, b) {
        if (void 0 === a && (a = !1), void 0 === b && (b = !1), 0 !== this.children.length) {
            do {
                ...
                d = this._hash.indexOf(c);
                -1 !== d && this._hash.splice(d, 1),
                a && c && c.destroy(!0)
    ...
    c.Group.prototype.removeBetween = function (a, b, c, d) {
        if (void 0 === b && (b = this.children.length - 1), void 0 === c && (c = !1), void 0 === d && (d = !1), 0 !== this.children.length) {
            ...
            for (var e = b; e >= a; ) {
                ...
                g = this._hash.indexOf(f);
                -1 !== g && this._hash.splice(g, 1),
                c && f && f.destroy(!0),
    ...
    c.Group.prototype.destroy = function (a, b) {
        null === this.game || this.ignoreDestroy || (void 0 === a && (a = !0), void 0 === b && (b = !1), this.onDestroy.dispatch(this, a, b), this.removeAll(a), this.cursor = null, this.filters = null, b || (this.parent && this.parent.removeChild(this), this.game = null, this.exists = !1))
    },
    ...
    c.ScaleManager.prototype = {
        ...
        startFullScreen: function (a, b) {
            ...
            if ("when-not-mouse" === this.compatibility.clickTrampoline) {
                ...
                if (e.activePointer && e.activePointer !== e.mousePointer && (b || !1 !== b))
        ...
        scaleSprite: function (a, b, c, d) {
            if (void 0 === b && (b = this.width), void 0 === c && (c = this.height), void 0 === d && (d = !1), a.scale.set(1), a.width <= 0 || a.height <= 0 || b <= 0 || c <= 0)
                return a;
            var e = b,
    ...
    Object.defineProperty(c.ScaleManager.prototype, "boundingParent", {
        get: function () {
            return this.parentIsWindow || this.isFullScreen && !this._createdFullScreenTarget ? null : this.game.canvas && this.game.canvas.parentNode || null
        }
    }),
    ...
    c.Game = function (a, b, d, e, f, g, h, i) {
        ...
        1 === arguments.length && "object" == typeof arguments[0] ? this.parseConfig(arguments[0]) : (this.config = {
                enableDebug: !1
            }, void 0 !== a && (this._width = a), void 0 !== b && (this._height = b), void 0 !== d && (this.renderType = d), void 0 !== e && (this.parent = e), void 0 !== g && (this.transparent = g), void 0 !== h && (this.antialias = h), this.rnd = new c.RandomDataGenerator([(Date.now() * Math.random()).toString()]), this.state = new c.StateManager(this, f)),
        window.__wx || (this.config.canvasID ? this.canvas = c.Canvas.create(this.width, this.height, this.config.canvasID) : this.canvas = c.Canvas.create(this.width, this.height)),
    ...
    c.Game.prototype = {
        parseConfig: function (a) {
            this.config = a,
            void 0 === a.enableDebug && (this.config.enableDebug = !1),
            a.width && (this._width = a.width),
            a.height && (this._height = a.height),
            a.canvas && (this.canvas = a.canvas),
        ...
        showDebugHeader: function () {
            if (!window.PhaserGlobal || !window.PhaserGlobal.hideBanner) {
                ...
                if (this.renderType === c.WEBGL ? (b = "WebGL", e++) : this.renderType == c.HEADLESS && (b = "Headless"), this.device.webAudio && (d = "WebAudio", e++), this.device.chrome) {
                    for (var f = ["%c %c %c Phaser v" + a + " | Pixi.js " + PIXI.VERSION + " | " + b + " | " + d + "  %c %c %c http://phaser.io %c♥%c♥%c♥", "background: #9854d8", "background: #6c2ca7", "color: #ffffff; background: #450f78;", "background: #6c2ca7", "background: #9854d8", "background: #ffffff"], g = 0; g < 3; g++)
        ...
        setUpRenderer: function () {
            if (window.__wx && (this.device.canvas = this.canvas), this.config.canvasStyle ? this.canvas.style = this.config.canvasStyle : this.canvas.style["-webkit-full-screen"] = "width: 100%; height: 100%", this.device.cocoonJS && (this.renderType === c.CANVAS ? this.canvas.screencanvas = !0 : this.canvas.screencanvas = !1), this.renderType === c.HEADLESS || this.renderType === c.CANVAS || this.renderType === c.AUTO && !1 === this.device.webGL) {
                ...
                this.renderType = c.WEBGL, this.renderer = new PIXI.WebGLRenderer(this.width, this.height, {
                    view: this.canvas,
                    transparent: this.transparent,
                    resolution: this.resolution,
        ...
        update: function (a) {
            if (this.time.update(a), this._kickstart)
                return this.updateLogic(1 / this.time.desiredFps), this.stage.updateTransform(), this.updateRender(this.time.slowMotion * this.time.desiredFps), void(this._kickstart = !1);
            if (this._spiraling > 1 && !this.forceSingleUpdate)
                this.time.time > this._nextFpsNotification && (this._nextFpsNotification = this.time.time + 1e4, this.fpsProblemNotifier.dispatch()), this._deltaTime = 0, this._spiraling = 0, this.updateRender(this.time.slowMotion * this.time.desiredFps);
            else {
    ...
    c.Input.prototype = {
        ...
        addPointer: function () {
            if (this.pointers.length >= c.Input.MAX_POINTERS)
                return console.warn("Phaser.Input.addPointer: only " + c.Input.MAX_POINTERS + " pointer allowed"), null;
        ...
        hitTest: function (a, b, d) {
            ...
            for (var i = 0, k = a.children.length; i < k; i++)
    ...
    c.Mouse.prototype = {
        start: function () {
            if ((!this.game.device.android || !1 !== this.game.device.chrome) && null === this._onMouseDown) {
                ...
                c && (this.game.canvas.addEventListener(c, this._onMouseWheel, !0), "mousewheel" === c ? this._wheelEvent = new a( - .025, 1) : "DOMMouseScroll" === c && (this._wheelEvent = new a(1, 1)))
            }
        },
    ...
    c.Pointer.prototype = {
        ...
        move: function (a, b) {
            if (!this.game.input.pollLocked) {
                if (void 0 === b && (b = !1), void 0 !== a.button && (this.button = a.button), this.clientX = a.clientX, this.clientY = a.clientY, this.pageX = a.pageX, this.pageY = a.pageY, this.screenX = a.screenX, this.screenY = a.screenY, this.isMouse && this.game.input.mouse.locked && !b && (this.rawMovementX = a.movementX || a.mozMovementX || a.webkitMovementX || 0, this.rawMovementY = a.movementY || a.mozMovementY || a.webkitMovementY || 0, this.movementX += this.rawMovementX, this.movementY += this.rawMovementY), this.x = (this.pageX - this.game.scale.offset.x) * this.game.input.scale.x, this.y = (this.pageY - this.game.scale.offset.y) * this.game.input.scale.y, this.position.setTo(this.x, this.y), this.circle.x = this.x, this.circle.y = this.y, (this.game.input.multiInputOverride === c.Input.MOUSE_OVERRIDES_TOUCH || this.game.input.multiInputOverride === c.Input.MOUSE_TOUCH_COMBINE || this.game.input.multiInputOverride === c.Input.TOUCH_OVERRIDES_MOUSE && 0 === this.game.input.currentPointers) && (this.game.input.activePointer = this, this.game.input.x = this.x, this.game.input.y = this.y, this.game.input.position.setTo(this.game.input.x, this.game.input.y), this.game.input.circle.x = this.game.input.x, this.game.input.circle.y = this.game.input.y), this.withinGame = this.game.scale.bounds.contains(this.pageX, this.pageY), this.game.paused)
                    return this;
                for (var d = this.game.input.moveCallbacks.length; d--; )
                    this.game.input.moveCallbacks[d].callback.call(this.game.input.moveCallbacks[d].context, this, this.x, this.y, b);
                return null !== this.targetObject && !0 === this.targetObject.isDragged ? !1 === this.targetObject.update(this) && (this.targetObject = null) : this.game.input.interactiveItems.total > 0 && this.processInteractiveObjects(b),
                this
            }
        },
        processInteractiveObjects: function (a) {
            for (var b = Number.MAX_VALUE, c = -1, d = null, e = this.game.input.interactiveItems.first; e; )
                e.checked = !1, e.validForInput(c, b, !1) && (e.checked = !0, (a && e.checkPointerDown(this, !0) || !a && e.checkPointerOver(this, !0)) && (b = e.sprite.renderOrderID, c = e.priorityID, d = e)), e = this.game.input.interactiveItems.next;
            for (var e = this.game.input.interactiveItems.first; e; )
                !e.checked && e.validForInput(c, b, !0) && (a && e.checkPointerDown(this, !1) || !a && e.checkPointerOver(this, !1)) && (b = e.sprite.renderOrderID, c = e.priorityID, d = e), e = this.game.input.interactiveItems.next;
        ...
        justReleased: function (a) {
            ...
            !0 === this.isUp && this.timeUp + a > this.game.time.time
        },
    ...
    c.InputHandler.prototype = {
        ...
        validForInput: function (a, b, c) {
            return void 0 === c && (c = !0),
            !(0 === this.sprite.scale.x || 0 === this.sprite.scale.y || this.priorityID < this.game.input.minPriorityID) && (!(!c && (this.pixelPerfectClick || this.pixelPerfectOver)) && (this.priorityID > a || this.priorityID === a && this.sprite.renderOrderID < b))
        },
        ...
        checkPointerDown: function (a, b) {
            return !!(a.isDown && this.enabled && this.sprite && this.sprite.parent && this.sprite.visible && this.sprite.parent.visible) && (!!this.game.input.hitTest(this.sprite, a, this._tempPoint) && (void 0 === b && (b = !1), !(!b && this.pixelPerfectClick) || this.checkPixel(this._tempPoint.x, this._tempPoint.y)))
        },
        checkPointerOver: function (a, b) {
            return !!(this.enabled && this.sprite && this.sprite.parent && this.sprite.visible && this.sprite.parent.visible) && (!!this.game.input.hitTest(this.sprite, a, this._tempPoint) && (void 0 === b && (b = !1), !(!b && this.pixelPerfectOver) || this.checkPixel(this._tempPoint.x, this._tempPoint.y)))
        },
        checkPixel: function (a, b, c) {
            if (this.sprite.texture.baseTexture.source) {
                ...
                d.hitContext || (d.hitCanvas = document.createElement("canvas"), d.hitCanvas.width = 1, d.hitCanvas.height = 1, d.hitContext = this.hitCanvas.getContext("2d")),
                d.hitContext.clearRect(0, 0, 1, 1),
                d.hitContext.drawImage(this.sprite.texture.baseTexture.source, a, b, 1, 1, 0, 0, 1, 1);
                if (d.hitContext.getImageData(0, 0, 1, 1).data[3] >= this.pixelPerfectAlpha)
                    return !0
            }
            return !1
        },
        update: function (a) {
            if (null !== this.sprite && void 0 !== this.sprite.parent)
                return this.enabled && this.sprite.visible && this.sprite.parent.visible ? this.draggable && this._draggedPointerID === a.id ? this.updateDrag(a) : this._pointerData[a.id].isOver ? this.checkPointerOver(a) ? (this._pointerData[a.id].x = a.x - this.sprite.x, this._pointerData[a.id].y = a.y - this.sprite.y, !0) : (this._pointerOutHandler(a), !1) : void 0 : (this._pointerOutHandler(a), !1)
        },
        _pointerOverHandler: function (a) {
            null !== this.sprite && (!1 === this._pointerData[a.id].isOver || a.dirty) && (this._pointerData[a.id].isOver = !0, this._pointerData[a.id].isOut = !1, this._pointerData[a.id].timeOver = this.game.time.time, this._pointerData[a.id].x = a.x - this.sprite.x, this._pointerData[a.id].y = a.y - this.sprite.y, this.useHandCursor && !1 === this._pointerData[a.id].isDragged && (this.game.canvas.style.cursor = "pointer", this._setHandCursor = !0), this.sprite && this.sprite.events && this.sprite.events.onInputOver$dispatch(this.sprite, a))
        },
        ...
        startDrag: function (a) {
            var b = this.sprite.x,
            c = this.sprite.y;
            if (this.isDragged = !0, this._draggedPointerID = a.id, this._pointerData[a.id].isDragged = !0, this.sprite.fixedToCamera)
                this.dragFromCenter ? (this.sprite.centerOn(a.x, a.y), this._dragPoint.setTo(this.sprite.cameraOffset.x - a.x, this.sprite.cameraOffset.y - a.y)) : this._dragPoint.setTo(this.sprite.cameraOffset.x - a.x, this.sprite.cameraOffset.y - a.y);
            else {
                    ...
                    for (var d, e = {
                        ...
                        if (d = this._gamepads[f], d.connected)
                            for (var g = 0; g < this._rawPads.length; g++)
                                this._rawPads[g].index === d.index && (e.rawIndices[d.index] = !0, e.padIndices[f] = !0);
    ...
    c.SinglePad.prototype = {
        ...
        connect: function (a) {
            ...
            for (var e in a.buttons)
                e = parseInt(e, 10), this._buttons[e] = new c.GamepadButton(this, e);
    ...
    c.Keyboard.prototype = {
        addCallbacks: function (a, b, c, d) {
            ...
            void 0 !== b && (this.onDownCallback = b),
            void 0 !== c && (this.onUpCallback = c),
            void 0 !== d && (this.onPressCallback = d)
        },
        addKey: function (a) {
    ...
    c.Component.InWorld.preUpdate = function () {
        if ((this.autoCull || this.checkWorldBounds) && (this._bounds.copyFrom(this.getBounds()), this._bounds.x += this.game.camera.view.x, this._bounds.y += this.game.camera.view.y, this.autoCull && (this.game.world.camera.view.intersects(this._bounds) ? (this.renderable = !0, this.game.world.camera.totalInView++) : this.renderable = !1), this.checkWorldBounds))
            if (this._outOfBoundsFired && this.game.world.bounds.intersects(this._bounds))
                this._outOfBoundsFired = !1, this.events.onEnterBounds$dispatch(this);
    ...
    Object.defineProperty(c.Rope.prototype, "segments", {
        get: function () {
            for (var a, b, d, e, f, g, h, i, j = [], k = 0; k < this.points.length; k++)
                a = 4 * k, b = this.verticies[a], d = this.verticies[a + 1], e = this.verticies[a + 4], f = this.verticies[a + 3], g = c.Math.difference(b, e), h = c.Math.difference(d, f), b += this.world.x, d += this.world.y, i = new c.Rectangle(b, d, g, h), j.push(i);
            return j
        }
    }),
    ...
    c.BitmapData.prototype = {
        ...
        processPixelRGB: function (a, b, d, e, f, g) {
            ...
            for (var h = d + f, i = e + g, j = c.Color.createColor(), k = {
                ...
                for (var n = d; n < h; n++)
                    c.Color.unpackPixel(this.getPixel32(n, m), j), !1 !== (k = a.call(b, j, n, m)) && null !== k && void 0 !== k && (this.setPixel32(n, m, k.r, k.g, k.b, k.a, !1), l = !0);
        ...
        processPixel: function (a, b, c, d, e, f) {
            ...
            for (var g = c + e, h = d + f, i = 0, j = 0, k = !1, l = d; l < h; l++)
                for (var m = c; m < g; m++)
                    i = this.getPixel32(m, l), (j = a.call(b, i, m, l)) !== i && (this.pixels[l * this.width + m] = j, k = !0);
            ...
            if (void 0 !== a && null !== a || (a = !1), void 0 !== b && null !== b || (b = !1), void 0 !== d && null !== d || (d = !1), a || b || d) {
                ...
                for (var f = c.Color.createColor(), g = e.y; g < e.bottom; g++)
                    for (var h = e.x; h < e.right; h++)
                        c.Color.unpackPixel(this.getPixel32(h, g), f, !0), a && (f.h = a), b && (f.s = b), d && (f.l = d), c.Color.HSLtoRGB(f.h, f.s, f.l, f), this.setPixel32(h, g, f.r, f.g, f.b, f.a, !1);
                return this.context.putImageData(this.imageData, 0, 0),
                this.dirty = !0,
                this
            }
        ...
        shiftHSL: function (a, b, d, e) {
            if (void 0 !== a && null !== a || (a = !1), void 0 !== b && null !== b || (b = !1), void 0 !== d && null !== d || (d = !1), a || b || d) {
                ...
                for (var f = c.Color.createColor(), g = e.y; g < e.bottom; g++)
                    for (var h = e.x; h < e.right; h++)
                        c.Color.unpackPixel(this.getPixel32(h, g), f, !0), a && (f.h = this.game.math.wrap(f.h + a, 0, 1)), b && (f.s = this.game.math.limitValue(f.s + b, 0, 1)), d && (f.l = this.game.math.limitValue(f.l + d, 0, 1)), c.Color.HSLtoRGB(f.h, f.s, f.l, f), this.setPixel32(h, g, f.r, f.g, f.b, f.a, !1);
                return this.context.putImageData(this.imageData, 0, 0),
                this.dirty = !0,
                this
            }
        ...
        setPixel32: function (a, b, d, e, f, g, h) {
            return void 0 === h && (h = !0),
            a >= 0 && a <= this.width && b >= 0 && b <= this.height && (c.Device.LITTLE_ENDIAN ? this.pixels[b * this.width + a] = g << 24 | f << 16 | e << 8 | d : this.pixels[b * this.width + a] = d << 24 | e << 16 | f << 8 | g, h && (this.context.putImageData(this.imageData, 0, 0), this.dirty = !0)),
            this
        },
        ...
        copy: function (a, b, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r) {
            if (void 0 !== a && null !== a || (a = this), this._image = a, a instanceof c.Sprite || a instanceof c.Image || a instanceof c.Text)
                this._pos.set(a.texture.crop.x, a.texture.crop.y), this._size.set(a.texture.crop.width, a.texture.crop.height), this._scale.set(a.scale.x, a.scale.y), this._anchor.set(a.anchor.x, a.anchor.y), this._rotate = a.rotation, this._alpha.current = a.alpha, this._image = a.texture.baseTexture.source, void 0 !== g && null !== g || (g = a.x), void 0 !== h && null !== h || (h = a.y), a.texture.trim && (g += a.texture.trim.x - a.anchor.x * a.texture.trim.width, h += a.texture.trim.y - a.anchor.y * a.texture.trim.height), 16777215 !== a.tint && (a.cachedTint !== a.tint && (a.cachedTint = a.tint, a.tintedTexture = PIXI.CanvasTinter.getTintedTexture(a, a.tint)), this._image = a.tintedTexture);
            else {
        ...
        shadow: function (a, b, c, d) {
            void 0 === a || null === a ? this.context.shadowColor = "rgba(0,0,0,0)" : (this.context.shadowColor = a, this.context.shadowBlur = b || 5, this.context.shadowOffsetX = c || 10, this.context.shadowOffsetY = d || 10)
        },
        ...
        circle: function (a, b, c, d) {
            return void 0 !== d && (this.context.fillStyle = d),
        ...
        if (b)
            if (a[0]instanceof c.Point)
                for (e = 0; e < b.length / 3; e++)
                    i.push(a[b[3 * e]]), i.push(a[b[3 * e + 1]]), i.push(a[b[3 * e + 2]]), 3 === i.length && (this.drawTriangle(i, d), i = []);
            else
                for (e = 0; e < b.length; e++)
                    f.x = a[2 * b[e]], f.y = a[2 * b[e] + 1], i.push(f.copyTo({})), 3 === i.length && (this.drawTriangle(i, d), i = []);
        else if (a[0]instanceof c.Point)
            for (e = 0; e < a.length / 3; e++)
                this.drawTriangle([a[3 * e], a[3 * e + 1], a[3 * e + 2]], d);
        else
            for (e = 0; e < a.length / 6; e++)
                f.x = a[6 * e + 0], f.y = a[6 * e + 1], g.x = a[6 * e + 2], g.y = a[6 * e + 3], h.x = a[6 * e + 4], h.y = a[6 * e + 5], this.drawTriangle([f, g, h], d)
    },
    ...
    c.Text = function (a, b, d, e, f) {
        ...
        this.colors = [],
        this.setStyle(f),
        PIXI.Text.call(this, a, e, this.style),
        c.Component.Core.init.call(this, a, b, d, "", null),
        " " !== e && this.updateText()
    },
    ...
    c.Text.prototype.updateText = function () {
        ...
        var l,
        m;
        for (this._charCount = 0, f = 0; f < b.length; f++)
            l = this.style.strokeThickness / 2, m = this.style.strokeThickness / 2 + f * i + e.ascent, f > 0 && (m += k * f), "right" === this.style.align ? l += d - c[f] : "center" === this.style.align && (l += (d - c[f]) / 2), this.colors.length > 0 ? this.updateLine(b[f], l, m) : (this.style.stroke && this.style.strokeThickness && this.context.strokeText(b[f], l, m), this.style.fill && this.context.fillText(b[f], l, m));
        this.updateTexture()
    },
    ...
    Object.defineProperty(c.BitmapText.prototype, "fontSize", {
        ...
        set: function (a) {
            (a = parseInt(a, 10)) !== this._fontSize && (this._fontSize = a, this.style.font = this._fontSize + "px '" + this._font + "'", this.dirty = !0)
        }
    }),
    ...
    c.RetroFont.prototype.pasteLine = function (a, b, d, e) {
        for (var f = new c.Point, g = 0; g < a.length; g++)
            if (" " == a.charAt(g))
                b += this.characterWidth + e;
            else if (this.grabData[a.charCodeAt(g)] >= 0 && (this.stamp.frame = this.grabData[a.charCodeAt(g)], f.set(b, d), this.render(this.stamp, f, !1), (b += this.characterWidth + e) > this.width))
                break
    },
    ...
    c.RetroFont.prototype.updateOffset = function (a, b) {
        if (this.offsetX !== a || this.offsetY !== b) {
            for (var c = a - this.offsetX, d = b - this.offsetY, e = this.game.cache.getFrameData(this.stamp.key).getFrames(), f = e.length; f--; )
                e[f].x += c, e[f].y += d, PIXI.TextureCache[e[f].uuid].frame.x = e[f].x, PIXI.TextureCache[e[f].uuid].frame.y = e[f].y;
    ...
    c.Device.whenReady = function (a, b, c) {
        ...
        if (this.deviceReadyAt || !d)
            ...
            d._queue = d._queue || [], d._queue.push([a, b]);
        else {
    ...
    c.Device._initialize = function () {
        function a() {
            ...
            var b = /Silk/.test(a);
            (k.windows || k.macOS || k.linux && !b || k.chromeOS) && (k.desktop = !0),
        ...
        function b() {
            ...
            k.webGL = function () {
                try {
                    ...
                    !!window.WebGLRenderingContext && (a.getContext("webgl", b) || a.getContext("experimental-webgl", b))
                } catch (a) {
                    return !1
                }
            }
            ...
            k.quirksMode = "CSS1Compat" !== document.compatMode,
        ...
        function c() {
            ("ontouchstart" in document.documentElement || window.navigator.maxTouchPoints && window.navigator.maxTouchPoints >= 1) && (k.touch = !0),
        ...
        function e() {
            ...
            if (/Arora/.test(a) ? k.arora = !0 : /Chrome/.test(a) ? k.chrome = !0 : /Epiphany/.test(a) ? k.epiphany = !0 : /Firefox/.test(a) ? k.firefox = !0 : /AppleWebKit/.test(a) && k.iOS ? k.mobileSafari = !0 : /MSIE (\d+\.\d+);/.test(a) ? (k.ie = !0, k.ieVersion = parseInt(RegExp.$1, 10)) : /Midori/.test(a) ? k.midori = !0 : /Opera/.test(a) ? k.opera = !0 : /Safari/.test(a) ? k.safari = !0 : /Trident\/(\d+\.\d+)(.*)rv:(\d+\.\d+)/.test(a) && (k.ie = !0, k.trident = !0, k.tridentVersion = parseInt(RegExp.$1, 10), k.ieVersion = parseInt(RegExp.$3, 10)), /Silk/.test(a) && (k.silk = !0), navigator.standalone && (k.webApp = !0), void 0 !== window.cordova && (k.cordova = !0), "undefined" != typeof process && "undefined" != typeof require && (k.node = !0), k.node)
                try {
                    k.nodeWebkit = void 0 !== require("nw.gui")
                } catch (a) {
                    k.nodeWebkit = !1
                }
            if (navigator.isCocoonJS && (k.cocoonJS = !0), k.cocoonJS)
                try {
                    k.cocoonJSApp = "undefined" != typeof CocoonJS
                } catch (a) {
                    k.cocoonJSApp = !1
                }
            void 0 !== window.ejecta && (k.ejecta = !0),
        ...
        function f() {
            ...
            try {
                !!a.canPlayType && (a.canPlayType('audio/ogg; codecs="vorbis"').replace(/^no$/, "") && (k.ogg = !0), (a.canPlayType('audio/ogg; codecs="opus"').replace(/^no$/, "") || a.canPlayType("audio/opus;").replace(/^no$/, "")) && (k.opus = !0), a.canPlayType("audio/mpeg;").replace(/^no$/, "") && (k.mp3 = !0), a.canPlayType('audio/wav; codecs="1"').replace(/^no$/, "") && (k.wav = !0), (a.canPlayType("audio/x-m4a;") || a.canPlayType("audio/aac;").replace(/^no$/, "")) && (k.m4a = !0), a.canPlayType('audio/webm; codecs="vorbis"').replace(/^no$/, "") && (k.webm = !0))
            } catch (a) {}
        }
        function g() {
            ...
            "undefined" != typeof Int8Array ? k.typedArray = !0 : k.typedArray = !1,
        ...
        function i() {
            if ("undefined" == typeof Uint8ClampedArray)
                return !1;
            var a = PIXI.sharedCanvas,
            b = a.getContext("2d");
            return !!b && b.createImageData(1, 1).data instanceof Uint8ClampedArray
        }
        function j() {
            var a,
    ...
    c.Device.canPlayAudio = function (a) {
        return !("mp3" != a || !this.mp3) || (!("ogg" != a || !this.ogg && !this.opus) || (!("m4a" != a || !this.m4a) || (!("opus" != a || !this.opus) || (!("wav" != a || !this.wav) || !("webm" != a || !this.webm)))))
    },
    ...
    c.RandomDataGenerator.prototype = {
        ...
        hash: function (a) {
            ...
            for (d = 4022871197, a = a.toString(), c = 0; c < a.length; c++)
                d += a.charCodeAt(c), b = .02519603282416938 * d, d = b >>> 0, b -= d, b *= d, d = b >>> 0, b -= d, d += 4294967296 * b;
    ...
    c.QuadTree.prototype = {
        ...
        insert: function (a) {
            ...
            if (this.objects.push(a), this.objects.length > this.maxObjects && this.level < this.maxLevels)
                for (null == this.nodes[0] && this.split(); c < this.objects.length; )
                    b = this.getIndex(this.objects[c]), -1 !== b ? this.nodes[b].insert(this.objects.splice(c, 1)[0]) : c++
        },
        getIndex: function (a) {
            var b = -1;
        ...
        retrieve: function (a) {
            if (a instanceof c.Rectangle)
                var b = this.objects, d = this.getIndex(a);
            else {
                if (!a.body)
                    return this._empty;
                var b = this.objects,
        ...
        clear: function () {
            ...
            for (var a = this.nodes.length; a--; )
                this.nodes[a].clear(), this.nodes.splice(a, 1);
            this.nodes.length = 0
        }
    },
    ...
    c.Tween.prototype = {
        ...
        start: function (a) {
            ...
            for (var b = 0; b < this.timeline.length; b++)
                for (var c in this.timeline[b].vEnd)
                    this.properties[c] = this.target[c] || 0, Array.isArray(this.properties[c]) || (this.properties[c] *= 1);
            for (var b = 0; b < this.timeline.length; b++)
        ...
        update: function (a) {
            ...
            if (b === c.TweenData.RUNNING)
                return null !== this._onUpdateCallback && this._onUpdateCallback.call(this._onUpdateCallbackContext, this, this.timeline[this.current].value, this.timeline[this.current]), this.isRunning;
            if (b === c.TweenData.LOOPED)
                return this.onLoop.dispatch(this.target, this), !0;
            if (b === c.TweenData.COMPLETE) {
                var d = !1;
                return this.reverse ? --this.current < 0 && (this.current = this.timeline.length - 1, d = !0) : ++this.current === this.timeline.length && (this.current = 0, d = !0),
        ...
        generateData: function (a, b) {
            ...
            for (var c = 0; c < this.timeline.length; c++)
                for (var d in this.timeline[c].vEnd)
                    this.properties[d] = this.target[d] || 0, Array.isArray(this.properties[d]) || (this.properties[d] *= 1);
            for (var c = 0; c < this.timeline.length; c++)
    ...
    c.TweenData.prototype = {
        ...
        start: function () {
            if (this.startTime = this.game.time.time + this.delay, this.parent.reverse ? this.dt = this.duration : this.dt = 0, this.delay > 0 ? this.isRunning = !1 : this.isRunning = !0, this.isFrom)
                for (var a in this.vStartCache)
                    this.vStart[a] = this.vEndCache[a], this.vEnd[a] = this.vStartCache[a], this.parent.target[a] = this.vStart[a];
            return this.value = 0,
            this.yoyoCounter = 0,
            this
        },
        ...
        update: function () {
            ...
            for (var a in this.vEnd) {
                var b = this.vStart[a],
                d = this.vEnd[a];
                Array.isArray(d) ? this.parent.target[a] = this.interpolationFunction.call(this.interpolationContext, d, this.value) : this.parent.target[a] = b + (d - b) * this.value
            }
        ...
        repeat: function () {
            ...
            if (this.inReverse)
                for (var a in this.vStartCache)
                    this.vStart[a] = this.vEndCache[a], this.vEnd[a] = this.vStartCache[a];
            else {
                for (var a in this.vStartCache)
                    this.vStart[a] = this.vStartCache[a], this.vEnd[a] = this.vEndCache[a];
    ...
    c.Easing = {
        ...
        Elastic: {
            ...
            InOut: function (a) {
                ...
                c = .1,
                d = .4;
                return 0 === a ? 0 : 1 === a ? 1 : (!c || c < 1 ? (c = 1, b = d / 4) : b = d * Math.asin(1 / c) / (2 * Math.PI), (a *= 2) < 1 ? c * Math.pow(2, 10 * (a -= 1)) * Math.sin((a - b) * (2 * Math.PI) / d) *  - .5 : c * Math.pow(2, -10 * (a -= 1)) * Math.sin((a - b) * (2 * Math.PI) / d) * .5 + 1)
            }
        },
        Back: {
            In: function (a) {
    ...
    c.Time.prototype = {
        ...
        update: function (a) {
            ...
            if (this.time = Date.now(), this.elapsedMS = this.time - b, this.prevTime = this.now, this.now = a, this.elapsed = this.now - this.prevTime, this.timeToCall = Math.floor(Math.max(0, 1e3 / this.desiredFps - (this.timeCallExpected - a))), this.timeCallExpected = a + this.timeToCall, this._frameCount++, this._elapsedAccumulator += this.elapsed, this._frameCount >= 2 * this.desiredFps && (this.suggestedFps = 5 * Math.floor(200 / (this._elapsedAccumulator / this._frameCount)), this._frameCount = 0, this._elapsedAccumulator = 0), this.physicsElapsed = 1 / this.desiredFps, this.physicsElapsedMS = 1e3 * this.physicsElapsed, this.advancedTiming && (this.msMin = Math.min(this.msMin, this.elapsed), this.msMax = Math.max(this.msMax, this.elapsed), this.frames++, this.now > this._timeLastSecond + 1e3 && (this.fps = Math.round(1e3 * this.frames / (this.now - this._timeLastSecond)), this.fpsMin = Math.min(this.fpsMin, this.fps), this.fpsMax = Math.max(this.fpsMax, this.fps), this._timeLastSecond = this.now, this.frames = 0)), !this.game.paused) {
                ...
                for (var c = 0, d = this._timers.length; c < d; )
                    this._timers[c].update(this.time) ? c++ : (this._timers.splice(c, 1), d--)
            }
        },
        gamePaused: function () {
        ...
        update: function (a) {
            ...
            if (this.elapsed = a - this._now, this._now = a, this.elapsed > this.timeCap && this.adjustEvents(a - this.elapsed), this._marked = 0, this.clearPendingEvents(), this.running && this._now >= this.nextTick && this._len > 0) {
                for (; this._i < this._len && this.running && this._now >= this.events[this._i].tick && !this.events[this._i].pendingDelete; )
                    this._newTick = this._now + this.events[this._i].delay - (this._now - this.events[this._i].tick), this._newTick < 0 && (this._newTick = this._now + this.events[this._i].delay), !0 === this.events[this._i].loop ? (this.events[this._i].tick = this._newTick, this.events[this._i].callback.apply(this.events[this._i].callbackContext, this.events[this._i].args)) : this.events[this._i].repeatCount > 0 ? (this.events[this._i].repeatCount--, this.events[this._i].tick = this._newTick, this.events[this._i].callback.apply(this.events[this._i].callbackContext, this.events[this._i].args)) : (this._marked++, this.events[this._i].pendingDelete = !0, this.events[this._i].callback.apply(this.events[this._i].callbackContext, this.events[this._i].args)), this._i++;
    ...
    c.Animation.prototype = {
        ...
        updateCurrentFrame: function (a) {
            return !!this._frameData && (this.currentFrame = this._frameData.getFrame(this._frames[this._frameIndex]), this.currentFrame && (this._parent.setFrame(this.currentFrame), this._parent.__tilePattern && (this._parent.__tilePattern = !1, this._parent.tilingTexture = !1)), !this.onUpdate || !a || (this.onUpdate.dispatch(this, this.currentFrame), !!this._frameData))
        },
        next: function (a) {
            void 0 === a && (a = 1);
    ...
    c.Animation.generateFrameNames = function (a, b, d, e, f) {
        ...
        if (b < d)
            for (var i = b; i <= d; i++)
                h = "number" == typeof f ? c.Utils.pad(i.toString(), f, "0", 1) : i.toString(), h = a + h + e, g.push(h);
        else
            for (var i = b; i >= d; i--)
                h = "number" == typeof f ? c.Utils.pad(i.toString(), f, "0", 1) : i.toString(), h = a + h + e, g.push(h);
        return g
    ...
    c.FrameData.prototype = {
        ...
        getFrameIndexes: function (a, b, c) {
            if (void 0 === b && (b = !0), void 0 === c && (c = []), void 0 === a || 0 === a.length)
                for (var d = 0, e = this._frames.length; d < e; d++)
    ...
    c.AnimationParser = {
        spriteSheet: function (a, b, d, e, f, g, h) {
            ...
            n = l * m;
            if (-1 !== f && (n = f), 0 === j || 0 === k || j < d || k < e || 0 === n)
            ...
            for (var o = new c.FrameData, p = g, q = g, r = 0; r < n; r++) {
                var s = a.rnd.uuid();
                o.addFrame(new c.Frame(r, p, q, d, e, r.toString(), s)),
        ...
        XMLData: function (a, b, d) {
            ...
            for (var e, f, g, h, i, j, k, l, m, n, o, p, q = new c.FrameData, r = b.getElementsByTagName("SubTexture"), s = 0; s < r.length; s++)
    ...
    c.Cache.prototype = {
        ...
        addBitmapData: function (a, b, d) {
            return b.key = a,
            void 0 === d && (d = new c.FrameData, d.addFrame(b.textureFrame)),
            this._bitmapDatas[a] = {
                data: b,
                frameData: d
            },
    ...
    c.Loader.prototype = {
        ...
        tilemap: function (a, b, d, e) {
            if (void 0 === b && (b = null), void 0 === d && (d = null), void 0 === e && (e = c.Tilemap.CSV), !b && !d)
        ...
        bitmapFont: function (a, b, c, d, e, f) {
            if (void 0 === c && (c = null), void 0 === d && (d = null), void 0 === e && (e = 0), void 0 === f && (f = 0), c)
        ...
        atlas: function (a, b, d, e, f) {
            if (void 0 === d && (d = null), void 0 === e && (e = null), void 0 === f && (f = c.Loader.TEXTURE_ATLAS_JSON_ARRAY), d)
        ...
        loadFile: function (a) {
            ...
            case "bitmapfont":
                ...
                break;
            case "audio":
                if (a.url = this.getAudioURL(a.url), a.url) {
                    if (this.game.sound.usingWebAudio)
                        this.xhrLoad(a, this.transformUrl(a.url, a), "arraybuffer", this.fileComplete);
                    else if (this.game.sound.usingAudioTag)
                        if (window.__wx && "function" != typeof wx.getSharedCanvas) {
                            var b = this,
                            d = wx.getFileSystemManager(),
                            e = "",
                            f = [wx.env.USER_DATA_PATH];
                            f = f.concat(a.url.split("/"));
                            for (var g = 0; g < f.length - 1; g++) {
                                ...
                                try {
                                    ...
                                    try {
                                        ...
                                        b.game._qc.log.trace("创建目录{0}失败：{1}", e, JSON.stringify(a))
                                    }
                                }
                            }
                            wx.downloadFile({
                                url: this.transformUrl(a.url, a),
                                filePath: wx.env.USER_DATA_PATH + "/" + a.url,
                                success: function (c) {
                                    b.game._qc.log.trace("音频 {0} 下载成功. res : {1}", a.url, JSON.stringify(c)),
                                    a.localPath = wx.env.USER_DATA_PATH + "/" + a.url,
                                    b.loadAudioTag(a)
                                },
                                fail: function (c) {
                                    b.game._qc.log.error("Download " + b.transformUrl(a.url, a) + " fail：" + JSON.stringify(c)),
                                    b.asyncComplete(a, "Download fail: " + a.url)
                                }
                            })
                        } else
                            this.loadAudioTag(a)
                } else
                    this.fileError(a, null, "no supported audio URL specified");
                break;
            case "json":
        ...
        loadAudioTag: function (a) {
            ...
            if (this.game.sound.touchLocked)
                a.data = new Audio, a.data.name = a.key, a.data.preload = "auto", a.data.src = this.transformUrl(a.url, a), this.fileComplete(a);
            else {
                a.data = new Audio,
                a.data.name = a.key;
                var d = function () {
        ...
        xhrLoad: function (a, b, c, d, e) {
            ...
            if (window.__wx && "function" != typeof wx.getSharedCanvas) {
                ...
                var g = wx.request({
                    ...
                    success: function (b) {
                        try {
                            return d.call(f, a, b.data)
                        } catch (b) {
                            f.hasLoaded ? window.console && console.error(b) : f.asyncComplete(a, b.message || "Exception")
                        }
                    },
                    fail: function (b) {
                        try {
        ...
        getAudioURL: function (a) {
            for (var b = 0; b < a.length; b++) {
                ...
                if (d.uri)
                    ...
                    c = d.substr((Math.max(0, d.lastIndexOf(".")) || 1 / 0) + 1).toLowerCase()
                }
        ...
        fileComplete: function (a, b) {
            var d,
            e = !0;
            switch (d = window.__wx && "function" != typeof wx.getSharedCanvas ? b : "binary" === a.type || "audio" === a.type ? b.response : b.responseText, a.type) {
            case "packfile":
                var f = JSON.parse(d);
                a.data = f || {};
                break;
            ...
            case "textureatlas":
                if (null == a.atlasURL)
                    this.game.cache.addTextureAtlas(a.key, a.url, a.data, a.atlasData, a.format);
                else if (e = !1, a.format == c.Loader.TEXTURE_ATLAS_JSON_ARRAY || a.format == c.Loader.TEXTURE_ATLAS_JSON_HASH)
                ...
                break;
            case "bitmapfont":
                a.xmlURL ? (e = !1, this.xhrLoad(a, this.transformUrl(a.xmlURL, a), "text", this.xmlLoadComplete)) : this.game.cache.addBitmapFont(a.key, a.url, a.data, a.xmlData, a.xSpacing, a.ySpacing);
                break;
            case "audio":
                this.game.sound.usingWebAudio ? (a.data = d, this.game.cache.addSound(a.key, a.url, a.data, !0, !1), a.autoDecode && this.game.sound.decode(a.key)) : this.game.cache.addSound(a.key, a.url, a.data, !1, !0);
                break;
            case "text":
                a.data = d,
            ...
            case "physics":
                var f = JSON.parse(d);
                this.game.cache.addPhysicsData(a.key, a.url, f, a.format);
                break;
            case "script":
                ...
                a.callback && (a.data = a.callback.call(a.callbackContext, a.key, d));
                break;
            case "binary":
                a.callback ? a.data = a.callback.call(a.callbackContext, a.key, d) : a.data = d,
                this.game.cache.addBinary(a.key, a.data)
            }
            e && this.asyncComplete(a)
        },
        jsonLoadComplete: function (a, b) {
            var c = window.__wx && "function" != typeof wx.getSharedCanvas ? b : JSON.parse(b.responseText);
        ...
        csvLoadComplete: function (a, b) {
            var c = window.__wx && "function" != typeof wx.getSharedCanvas ? b : b.responseText;
    ...
    c.LoaderParser = {
        bitmapFont: function (a, b, c, d, e) {
            if (window.__wx && window.Tautologistics) {
                var f = {},
                g = Tautologistics.NodeHtmlParser.DomUtils.getElementsByTagName("info", b)[0],
                h = Tautologistics.NodeHtmlParser.DomUtils.getElementsByTagName("common", b)[0];
                f.font = g.attribs.face,
                f.size = parseInt(g.attribs.size, 10),
                f.lineHeight = parseInt(h.attribs.lineHeight, 10) + e,
                f.chars = {};
                for (var i = Tautologistics.NodeHtmlParser.DomUtils.getElementsByTagName("char", b), j = 0; j < i.length; j++) {
                    var k = parseInt(i[j].attribs.id, 10),
                    l = new PIXI.Rectangle(parseInt(i[j].attribs.x, 10), parseInt(i[j].attribs.y, 10), parseInt(i[j].attribs.width, 10), parseInt(i[j].attribs.height, 10));
                    f.chars[k] = {
                        xOffset: parseInt(i[j].attribs.xoffset, 10),
                        yOffset: parseInt(i[j].attribs.yoffset, 10),
                        xAdvance: parseInt(i[j].attribs.xadvance, 10) + d,
                        kerning: {},
                        texture: PIXI.TextureCache[c] = new PIXI.Texture(PIXI.BaseTextureCache[c], l)
                    }
                }
                var m = Tautologistics.NodeHtmlParser.DomUtils.getElementsByTagName("kerning", b);
                for (j = 0; j < m.length; j++) {
                    var n = parseInt(m[j].attribs.first, 10),
                    o = parseInt(m[j].attribs.second, 10),
                    p = parseInt(m[j].attribs.amount, 10);
                    f.chars[o].kerning[n] = p
                }
                return void(PIXI.BitmapText.fonts[c] = f)
            }
            var f = {},
    ...
    c.Sound.prototype = {
        ...
        play: function (a, b, c, d, e) {
            if (void 0 !== a && !1 !== a && null !== a || (a = ""), void 0 === e && (e = !0), this.isPlaying && !this.allowMultiple && !e && !this.override)
                return this;
            ...
            if ("" === a && Object.keys(this.markers).length > 0)
                return this;
            if ("" !== a) {
                if (this.currentMarker = a, !this.markers[a])
                    return this;
                ...
                b = b || 0, void 0 === c && (c = this._volume), void 0 === d && (d = this.loop), this.position = b, this.volume = c, this.loop = d, this.duration = 0, this.durationMS = 0, this._tempMarker = a, this._tempPosition = b, this._tempVolume = c, this._tempLoop = d;
        ...
        resume: function () {
            if (this.paused && this._sound) {
                if (this.usingWebAudio) {
                    ...
                    void 0 === this._sound.start ? this._sound.noteGrainOn(0, a, b) : this._sound.start(0, a, b)
                } else
                    this._sound.play();
                this.isPlaying = !0,
                this.paused = !1,
        ...
        stop: function () {
            ...
            this.paused || this.onStop.dispatch(this, a)
        },
    ...
    Object.defineProperty(c.Sound.prototype, "volume", {
        ...
        set: function (a) {
            this.usingWebAudio ? (this._volume = a, this.gainNode.gain.value = a) : this.usingAudioTag && this._sound && a >= 0 && a <= 1 && (this._volume = a, this._sound.volume = a)
        }
    }),
    ...
    c.SoundManager.prototype = {
        boot: function () {
            if (this.game.device.iOS && !1 === this.game.device.webAudio && (this.channels = 1), !this.game.device.cocoonJS && this.game.device.iOS || window.PhaserGlobal && window.PhaserGlobal.fakeiOSTouchLock ? (this.game.input.touch.callbackContext = this, this.game.input.touch.touchStartCallback = this.unlock, this.game.input.mouse.callbackContext = this, this.game.input.mouse.mouseDownCallback = this.unlock, this.touchLocked = !0) : this.touchLocked = !1, window.PhaserGlobal) {
            ...
            null !== this.context && (void 0 === this.context.createGain ? this.masterGain = this.context.createGainNode() : this.masterGain = this.context.createGain(), this.masterGain.gain.value = 1, this.masterGain.connect(this.context.destination))
        },
        unlock: function () {
            if (!1 !== this.touchLocked)
                if (!1 === this.game.device.webAudio || window.PhaserGlobal && !0 === window.PhaserGlobal.disableWebAudio)
        ...
        update: function () {
            ...
            if (this._watching) {
                for (var b = this._watchList.first; b; )
                    this.game.cache.isSoundDecoded(b) && this._watchList.remove(b), b = this._watchList.next;
    ...
    c.Utils.Debug.prototype = {
        ...
        line: function () {
            for (var a = this.currentX, b = 0; b < arguments.length; b++)
                this.renderShadow && (this.context.fillStyle = "rgb(0,0,0)", this.context.fillText(arguments[b], a + 1, this.currentY + 1), this.context.fillStyle = this.currentColor), this.context.fillText(arguments[b], a, this.currentY), a += this.columnWidth;
    ...
    c.ArrayUtils = {
        ...
        rotateMatrix: function (a, b) {
            if ("string" != typeof b && (b = (b % 360 + 360) % 360), 90 === b || -270 === b || "rotateLeft" === b)
                a = c.ArrayUtils.transposeMatrix(a), a = a.reverse();
            else if (-90 === b || 270 === b || "rotateRight" === b)
                a = a.reverse(), a = c.ArrayUtils.transposeMatrix(a);
        ...
        numberArrayStep: function (a, b, d) {
            ...
            for (var f = -1, g = Math.max(c.Math.roundAwayFromZero((b - a) / (d || 1)), 0), h = new Array(g); ++f < g; )
                h[f] = a, a += d;
            return h
        }
    },
    c.Color = {
        ...
        RGBtoHSV: function (a, b, d, e) {
            ...
            e.s = 0 === g ? 0 : h / g,
            e.v = g,
            g !== f && (g === a ? e.h = (b - d) / h + (b < d ? 6 : 0) : g === b ? e.h = (d - a) / h + 2 : g === d && (e.h = (a - b) / h + 4), e.h /= 6),
            e
        },
    ...
    c.LinkedList.prototype = {
        ...
        remove: function (a) {
            if (1 === this.total)
                return this.reset(), void(a.next = a.prev = null);
    ...
    c.Physics.prototype = {
        parseConfig: function () {
            this.config.hasOwnProperty("arcade") && !0 !== this.config.arcade || !c.Physics.hasOwnProperty("Arcade") || (this.arcade = new c.Physics.Arcade(this.game), this.game.time.deltaCap = .2),
            ...
            c.Physics.hasOwnProperty("BOX2D") && (this.box2d = new c.Physics.BOX2D(this.game, this.config))
        },
        ...
        preUpdate: function () {
            this.arcade && this.arcade.preUpdate(),
    ...
    c.Tilemap.prototype = {
        ...
        addTilesetImage: function (a, b, d, e, f, g, h) {
            if (void 0 === d && (d = this.tileWidth), void 0 === e && (e = this.tileHeight), void 0 === f && (f = 0), void 0 === g && (g = 0), void 0 === h && (h = 0), 0 === d && (d = 32), 0 === e && (e = 32), void 0 === b) {
                if ("string" != typeof a)
                    return null;
                if (b = a, !this.game.cache.checkImageKey(b))
                    return console.warn('Phaser.Tilemap.addTilesetImage: Invalid image key given: "' + b + '"'), null
            }
            if ("string" == typeof a && null === (a = this.getTilesetIndex(a)) && this.format === c.Tilemap.TILED_JSON)
                return console.warn('Phaser.Tilemap.addTilesetImage: No data found in the JSON matching the tileset name: "' + b + '"'), null;
            if (this.tilesets[a])
                return this.tilesets[a].setImage(this.game.cache.getImage(b)), this.tilesets[a];
            var i = new c.Tileset(b, h, d, e, f, g, {});
            i.setImage(this.game.cache.getImage(b)),
            this.tilesets.push(i);
            for (var j = this.tilesets.length - 1, k = f, l = f, m = 0, n = 0, o = 0, p = h; p < h + i.total && (this.tiles[p] = [k, l, j], k += d + g, ++m !== i.total) && (++n !== i.columns || (k = f, l += e + g, n = 0, ++o !== i.rows)); p++);
            return i
        },
        createFromObjects: function (a, b, d, e, f, g, h, i, j) {
            ...
            for (var k, l = 0, m = this.objects[a].length; l < m; l++)
        ...
        createFromTiles: function (a, b, d, e, f, g) {
            ...
            if (this.copy(0, 0, h, i, e), this._results.length < 2)
                return 0;
            ...
            if (1 === b.length)
                for (l = 0; l < a.length; l++)
                    this.replace(a[l], b[0], 0, 0, h, i, e);
            else if (b.length > 1)
                for (l = 0; l < a.length; l++)
                    this.replace(a[l], b[l], 0, 0, h, i, e);
            return k
        },
        createLayer: function (a, b, d, e) {
            void 0 === b && (b = this.game.width),
        ...
        setCollision: function (a, b, c, d) {
            if (void 0 === b && (b = !0), void 0 === d && (d = !0), c = this.getLayer(c), "number" == typeof a)
        ...
        setCollisionByIndex: function (a, b, c, d) {
            if (void 0 === b && (b = !0), void 0 === c && (c = this.currentLayer), void 0 === d && (d = !0), b)
        ...
        dump: function () {
            for (var a = "", b = [""], c = 0; c < this.layers[this.currentLayer].height; c++) {
                for (var d = 0; d < this.layers[this.currentLayer].width; d++)
                    a += "%c  ", this.layers[this.currentLayer].data[c][d] > 1 ? this.debugMap[this.layers[this.currentLayer].data[c][d]] ? b.push("background: " + this.debugMap[this.layers[this.currentLayer].data[c][d]]) : b.push("background: #ffffff") : b.push("background: rgb(0, 0, 0)");
                a += "\n"
            }
            b[0] = a,
    ...
    c.TilemapLayer.prototype.shiftCanvas = function (a, b, c) {
        ...
        if (k) {
            ...
            a.save(), a.globalCompositeOperation = "copy", a.drawImage(d, g, h, e, f, i, j, e, f), a.restore()
    },
    ...
    c.TilemapLayer.prototype.render = function () {
        ...
        if (this.visible) {
            ...
            if (a || 0 !== g || 0 !== h || f.renderWidth !== b || f.renderHeight !== c)
                return f.scrollX = d, f.scrollY = e, f.renderWidth === b && f.renderHeight === c || (f.renderWidth = b, f.renderHeight = c), this.debug && (this.context.globalAlpha = this.debugSettings.debugAlpha, this.debugSettings.forceFullRedraw && (a = !0)), !a && this.renderSettings.enableScrollDelta && Math.abs(g) + Math.abs(h) < Math.min(b, c) ? this.renderDeltaScroll(g, h) : this.renderFull(), this.debug && (this.context.globalAlpha = 1, this.renderDebug()), this.baseTexture.dirty(), this.dirty = !1, this.context.restore(), !0
        }
    },
    ...
    c.TilemapParser = {
        parse: function (a, b, d, e, f, g) {
            if (void 0 === d && (d = 32), void 0 === e && (e = 32), void 0 === f && (f = 10), void 0 === g && (g = 10), void 0 === b)
                return this.getEmptyData();
            if (null === b)
                return this.getEmptyData(d, e, f, g);
            var h = a.cache.getTilemapData(b);
            if (h) {
                if (h.format === c.Tilemap.CSV)
                    return this.parseCSV(b, h.data, d, e);
                if (!h.format || h.format === c.Tilemap.TILED_JSON)
                    return this.parseTiledJSON(h.data)
            } else
                console.warn("Phaser.TilemapParser.parse - No map data found for key " + b)
        },
        parseCSV: function (a, b, d, e) {
            ...
            for (var g = [], h = b.split("\n"), i = h.length, j = 0, k = 0; k < h.length; k++) {
                ...
                for (var l = h[k].split(","), m = 0; m < l.length; m++)
                    g[k][m] = new c.Tile(f.layers[0], parseInt(l[m], 10), m, k, d, e);
                0 === j && (j = l.length)
            }
        ...
        getEmptyData: function (a, b, c, d) {
            ...
            e.tileWidth = 0,
            e.tileHeight = 0,
            void 0 !== a && null !== a && (e.tileWidth = a),
            void 0 !== b && null !== b && (e.tileHeight = b),
            void 0 !== c && null !== c && (e.width = c),
            void 0 !== d && null !== d && (e.height = d),
        ...
        parseTiledJSON: function (a) {
            ...
            for (var e = [], f = 0; f < a.layers.length; f++)
                if ("tilelayer" === a.layers[f].type) {
                    ...
                    for (var h, i, j, k, l = 0, m = [], n = [], o = 0, p = a.layers[f].data.length; o < p; o++) {
                        if (h = 0, i = !1, (k = a.layers[f].data[o]) > 536870912)
                            switch (j = 0, k > 2147483648 && (k -= 2147483648, j += 4), k > 1073741824 && (k -= 1073741824, j += 2), k > 536870912 && (k -= 536870912, j += 1), j) {
                            case 5:
                                h = Math.PI / 2;
                                break;
                            case 6:
            ...
            for (var v = {}, w = {}, f = 0; f < a.layers.length; f++)
                if ("objectgroup" === a.layers[f].type) {
                    v[a.layers[f].name] = [],
                    w[a.layers[f].name] = [];
                    for (var x = 0, p = a.layers[f].objects.length; x < p; x++)
                        if (a.layers[f].objects[x].gid) {
                            ...
                            a.layers[f].objects[x].rotation && (y.rotation = a.layers[f].objects[x].rotation),
                            y.polyline = [];
                            for (var z = 0; z < a.layers[f].objects[x].polyline.length; z++)
                                y.polyline.push([a.layers[f].objects[x].polyline[z].x, a.layers[f].objects[x].polyline[z].y]);
                            ...
                            y.polygon = [];
                            for (var z = 0; z < a.layers[f].objects[x].polygon.length; z++)
                                y.polygon.push([a.layers[f].objects[x].polygon[z].x, a.layers[f].objects[x].polygon[z].y]);
                            v[a.layers[f].name].push(y)
            ...
            for (var f = 0; f < d.tilesets.length; f++)
                for (var t = d.tilesets[f], l = t.tileMargin, A = t.tileMargin, B = 0, C = 0, D = 0, o = t.firstgid; o < t.firstgid + t.total && (d.tiles[o] = [l, A, f], l += t.tileWidth + t.tileSpacing, ++B !== t.total) && (++C !== t.columns || (l = t.tileMargin, A += t.tileHeight + t.tileSpacing, C = 0, ++D !== t.rows)); o++);
            for (var g, E, F, t, f = 0; f < d.layers.length; f++) {
                g = d.layers[f];
                for (var G = 0; G < g.data.length; G++) {
                    m = g.data[G];
                    for (var H = 0; H < m.length; H++)
                        E = m[H], E.index < 0 || (F = d.tiles[E.index][2], t = d.tilesets[F], t.tileProperties && t.tileProperties[E.index - t.firstgid] && (E.properties = c.Utils.mixin(t.tileProperties[E.index - t.firstgid], E.properties)))
                }
            }
            return d
        }
        ...
        updateTileData: function (a, b) {
            ...
            for (var e = this.tileMargin, f = this.tileMargin, g = 0; g < this.rows; g++) {
                for (var h = 0; h < this.columns; h++)
                    this.drawCoords.push(e), this.drawCoords.push(f), e += this.tileWidth + this.tileSpacing;
                e = this.tileMargin,
    ...
    "undefined" != typeof exports ? ("undefined" != typeof module && module.exports && (exports = module.exports = c), exports.Phaser = c) : "undefined" != typeof define && define.amd ? define("Phaser", function () {
        return b.Phaser = c
    }
        ()) : b.Phaser = c
}
